...
def html_convert():
    ...
    with open("tmp/page.html", "r") as file:
        ...
        filedata = filedata.replace(
            'class="alert-warning', 'class="alert alert-warning'
        )
        filedata = filedata.replace('class="alert-info', 'class="alert alert-info')
        filedata = filedata.replace(
            'class="alert-success', 'class="alert alert-success'
        )
        ...
        filedata = filedata.replace(
            'class="label-default', 'class="label label-default'
        )
        filedata = filedata.replace(
            'class="label-primary', 'class="label label-primary'
        )
        filedata = filedata.replace(
            'class="label-success', 'class="label label-success'
        )
        filedata = filedata.replace('class="label-info', 'class="label label-info')
        filedata = filedata.replace(
            'class="label-warning', 'class="label label-warning'
        )
        ...
        filedata = filedata.replace(
            '</nav><li class="active">', '<ul><li class="active">'
        )
        filedata = filedata.replace(
        ...
        filedata = filedata.replace(
            '<li class="instagram"><a', '<li><a class="instagram "'
        )
        filedata = filedata.replace(
            '<li class="linkedin"><a', '<li><a class="linkedin "'
        )
        filedata = filedata.replace(
    ...
    if lang == "en":
        ...
        return render_template(
            "code_en.html", lang=lang, html_page=html_page, aem_page=aem_page
        )

    if lang == "fr":

        return render_template(
            "code_fr.html", lang=lang, html_page=html_page, aem_page=aem_page
        )
